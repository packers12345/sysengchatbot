...
import api_integration_simple as api_integration # Import the updated api_integration module
...
def combined():
    ...
    try:
        system_design_output = api_integration.generate_system_designs(prompt)
    except Exception as e:
        print(f"Error calling generate_system_designs: {e}")
        system_design_output = f"Error generating system design: {str(e)}"

    try:
        verification_output = api_integration.create_verification_requirements_models(prompt)
    except Exception as e:
    ...
    try:
        ...
        morphism_image = api_integration.generate_network_visualization(graph_data)
    except Exception as e:
        morphism_image = None
...
def system_requirements():
    ...
    try:
        system_requirements_text = api_integration.generate_system_requirements(prompt)
        return jsonify({
